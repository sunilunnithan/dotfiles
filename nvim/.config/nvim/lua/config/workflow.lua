...
--
-- # NEW NOTE
-- >>> on "Note Name" # call my "obsidian new note" shell script (~/.local/bin/on)
-- >>>
...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd $HOME/sb")
--
-- convert note to template and remove leading white space
vim.keymap.set("n", "<leader>on", ":ObsidianTemplate Templates/note<cr> :lua vim.cmd([[1,/^\\S/s/^\\n\\{1,}//]])<cr>")
